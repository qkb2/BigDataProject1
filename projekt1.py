...
with DAG(
    ...
    # TODO Change your_username and your_bucket to real values
    params={
        "dags_home": Param("/home/your_username/airflow/dags", type="string"),
        "input_dir": Param("gs://your_bucket/projekt1/input", type="string"),
...
""",
    ...
    pick_pig_or_hive = BranchPythonOperator(
        task_id="pick_pig_or_hive",
        python_callable=_pick_pig_or_hive,
